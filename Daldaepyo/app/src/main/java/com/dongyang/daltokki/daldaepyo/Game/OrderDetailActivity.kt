...
class OrderDetailActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_order_detail.setOnClickListener {
            ...
            Toast.makeText(this@OrderDetailActivity, "주문 상세 정보를 입력하세요.", Toast.LENGTH_LONG).show()
            val intent = Intent(this@OrderDetailActivity, OrderDetailWriteActivity::class.java)
