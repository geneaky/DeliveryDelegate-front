...
import com.dongyang.daltokki.daldaepyo.Game.CreateGame.OrderDetailWriteActivity_Master
...
class AttendOrderDetailActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_order_detail.setOnClickListener {
            ...
            Toast.makeText(this@AttendOrderDetailActivity, "주문 상세 정보를 입력하세요.", Toast.LENGTH_LONG).show()
            val intent = Intent(this@AttendOrderDetailActivity, AttendOrderDetailWriteActivity::class.java)
