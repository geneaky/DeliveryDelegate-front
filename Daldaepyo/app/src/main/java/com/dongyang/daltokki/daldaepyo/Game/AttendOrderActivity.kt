...
import com.dongyang.daltokki.daldaepyo.Game.CreateGame.OrderDetailActivity_Master
...
class AttendOrderActivity : AppCompatActivity() {
        ...
        btn_searchBoard1.setOnClickListener {
            ...
            api.getSearch(tok, name).enqueue(object: Callback<SearchResponseDto> {
                override fun onResponse(call: Call<SearchResponseDto>,
                    ...
                    if(code == 500) {
                        Toast.makeText(this@AttendOrderActivity, "검색에 실패했습니다. 관리자에게 문의해 주세요.", Toast.LENGTH_SHORT).show()
                    }
